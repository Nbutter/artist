module Admin
  ...
  private
    ...
    def exhibition_params
      params.require(:exhibition).permit(:venue_id, :title, :subtitle, :exhibition_type, :press_url, :curator, :start_month, :finish_month, :year, :exhibition_image_url, :exhibition_image_url2)
    end
end
