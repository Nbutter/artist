module Admin 
  class ArtworkImagesController < ApplicationController
    ...
    def index
      @artwork_image_images = ArtworkImage.all
    end
    ...
    def create
      ...
      respond_to do |format|
        if @artwork_image.save
          format.html { redirect_to @artwork_image, notice: 'Artwork Image was successfully created.' }
          format.json { render :show, status: :created, location: @artwork_image }
        else
          format.html { render :new }
          format.json { render json: @artwork_image.errors, status: :unprocessable_entity }
        end
      end
    end
    ...
    def update
      respond_to do |format|
        if @artwork_image.update(artwork_image_params)
          ...
          format.json { render :show, status: :ok, location: @artwork_image }
        else
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to artwork_images_url, notice: 'Artwork Image was successfully destroyed.' }
